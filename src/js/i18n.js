  ...
  var translations = {
    pt: {
      ...
      b2c: {
        ...
        block1Title: 'Seu guia pessoal para o underground.',
        block1Text: "'Tenho 3 horas livres, o que está acontecendo no meu nicho?'. Nosso Concierge IA entende seu gosto e localização para entregar roteiros instantâneos. É a inteligência artificial a serviço da sua curiosidade cultural.",
        ...
        block2Title: 'Chega de ruído. Apenas sua cena.',
        block2Text: 'Esqueça o mainstream. Nosso Smart Feed prioriza eventos por afinidade real, distância e benefícios exclusivos. Visualize apenas o que importa para você, de Jazz Experimental a Post-Punk.',
        block3Title: 'Uma experiência que vai além do evento.',
        block3Text: 'O MyWeek conecta você a parceiros locais. Ganhe vouchers exclusivos em restaurantes, bares e transporte ao registrar interesse em um evento. Criamos o roteiro completo para que sua única preocupação seja aproveitar a noite.',
        feedCard1: 'Blue Note — Hoje 21h',
        feedCard2: 'D-Edge — Sáb 23h',
        feedCard3: 'Casa da Música — Sex 22h',
        ticketEvent: 'Jazz Night — Blue Note',
        ticketMeta: 'Sáb 21h · 1 ingresso',
        ticketSeal: 'jantar parceiro'
      },
      download: {
    ...
    en: {
      ...
      b2c: {
        ...
        block1Title: 'Your personal guide to the underground.',
        block1Text: "'I have 3 hours free — what's happening in my niche?' Our AI Concierge understands your taste and location to deliver instant itineraries. It's AI at the service of your cultural curiosity.",
        ...
        block2Title: 'No more noise. Just your scene.',
        block2Text: 'Forget the mainstream. Our Smart Feed prioritizes events by real affinity, distance, and exclusive benefits. See only what matters to you — from Experimental Jazz to Post-Punk.',
        block3Title: 'An experience that goes beyond the event.',
        block3Text: 'MyWeek connects you to local partners. Earn exclusive vouchers at restaurants, bars, and transportation when you register interest in an event. We create the full itinerary so your only concern is enjoying the night.',
        feedCard1: 'Blue Note — Today 9pm',
        feedCard2: 'D-Edge — Sat 11pm',
        feedCard3: 'Casa da Música — Fri 10pm',
        ticketEvent: 'Jazz Night — Blue Note',
        ticketMeta: 'Sat 9pm · 1 ticket',
        ticketSeal: 'partner dinner'
      },
      download: {
